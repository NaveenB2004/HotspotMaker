...
echo.
echo # v2.3 (this) - # v2.3 - Set default window and buffer sizes. Bugfix (task schedule for auto-update check environment variable error, updater codes error), Improve auto-update check.
echo.
echo ..........................................................
echo.
::user choicess
