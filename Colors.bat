...
echo.
set/p "colorcho=>"
if %colorcho%==A echo 0 >"%path%\colorcode.ini"
if %colorcho%==a echo 0 >"%path%\colorcode.ini"
if %colorcho%==B echo 1 >"%path%\colorcode.ini"
if %colorcho%==b echo 1 >"%path%\colorcode.ini"
if %colorcho%==c echo 2 >"%path%\colorcode.ini"
if %colorcho%==C echo 2 >"%path%\colorcode.ini"
if %colorcho%==D echo 3 >"%path%\colorcode.ini"
if %colorcho%==d echo 3 >"%path%\colorcode.ini"
if %colorcho%==E echo 4 >"%path%\colorcode.ini"
if %colorcho%==e echo 4 >"%path%\colorcode.ini"
if %colorcho%==F echo 5 >"%path%\colorcode.ini"
if %colorcho%==f echo 5 >"%path%\colorcode.ini"
if %colorcho%==G echo 6 >"%path%\colorcode.ini"
if %colorcho%==g echo 6 >"%path%\colorcode.ini"
if %colorcho%==H echo 7 >"%path%\colorcode.ini"
if %colorcho%==h echo 7 >"%path%\colorcode.ini"
if %colorcho%==I echo 8 >"%path%\colorcode.ini"
if %colorcho%==i echo 8 >"%path%\colorcode.ini"
if %colorcho%==J echo 9 >"%path%\colorcode.ini"
if %colorcho%==j echo 9 >"%path%\colorcode.ini"
if %colorcho%==K echo A >"%path%\colorcode.ini"
if %colorcho%==k echo A >"%path%\colorcode.ini"
if %colorcho%==L echo B >"%path%\colorcode.ini"
if %colorcho%==l echo B >"%path%\colorcode.ini"
if %colorcho%==M echo C >"%path%\colorcode.ini"
if %colorcho%==m echo C >"%path%\colorcode.ini"
if %colorcho%==N echo D >"%path%\colorcode.ini"
if %colorcho%==n echo D >"%path%\colorcode.ini"
if %colorcho%==O echo E >"%path%\colorcode.ini"
if %colorcho%==o echo E >"%path%\colorcode.ini"
if %colorcho%==P echo F >"%path%\colorcode.ini"
if %colorcho%==p echo F >"%path%\colorcode.ini"
